...
export const Tabs = {
    ...
    EXPERIENCE : {id: 3, open: false, vis: false, left: 0, top: 0, fullscreen: false, short_width: 40, short_height: 64, full_height: 90, zIndex: 0, opacity: 1, title: "Experience | Amit Gupta"},
    PROJECT : {id: 4, open: false, vis: false, left: 0, top: 0, fullscreen: false, short_width: 40, short_height: 64, full_height: 90, zIndex: 0, opacity: 1, title: "Projects | Amit Gupta"},
    ACHIEVEMENTS : {id: 5, open: false, vis: false, left: 0, top: 0, fullscreen: false, short_width: 40, short_height: 64, full_height: 90, zIndex: 0, opacity: 1, title: "Achievements | Amit Gupta"},
    VOLUNTEER : {id: 6, open: false, vis: false, left: 0, top: 0, fullscreen: false, short_width: 40, short_height: 64, full_height: 90, zIndex: 0, opacity: 1, title: "Volunteer | Amit Gupta"},
    BLOG : {id: 7, open: false, vis: false, left: 0, top: 0, fullscreen: false, short_width: 50, short_height: 64, full_height: 90, zIndex: 0, opacity: 1, title: "Blogs | Amit Gupta"},

export const Tabs = {
    ABOUT : {open: true, vis: true, x: 250, y: 100, fullscreen: false, short_width: 40, full_width: 90, zIndex: 0, title: "About | Amit Gupta"},
    EDUCATION : {open: false, vis: false, x: 250, y: 100, fullscreen: false, short_width: 40, full_width: 90, zIndex: 0, title: "Trash"},
    EXPERIENCE : {open: false, vis: false, x: 250, y: 100, fullscreen: false, short_width: 40, full_width: 90, zIndex: 0, title: "Trash"},
    ...
    ACHIEVEMENTS : {open: false, vis: false, x: 250, y: 100, fullscreen: false, short_width: 40, full_width: 90, zIndex: 0, title: "Trash"},
    VOLUNTEER : {open: false, vis: false, x: 250, y: 100, fullscreen: false, short_width: 40, full_width: 90, zIndex: 0, title: "Trash"},
    BLOG : {open: false, vis: false, x: 250, y: 200, fullscreen: false, short_width: 40, full_width: 90, zIndex: 0, title: "Blogs | Amit Gupta"},
    WRITEUP : {open: false, vis: false, x: 250, y: 100, fullscreen: false, short_width: 40, full_width: 90, zIndex: 0, title: "Writeups | Amit Gupta"},
